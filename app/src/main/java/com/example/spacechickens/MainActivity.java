...
import static com.example.spacechickens.Logic.GameManager.OBJECTS_COLS;
import static com.example.spacechickens.Logic.GameManager.OBJECTS_ROWS;
...
import com.example.spacechickens.Audio.SoundManager;
import com.example.spacechickens.Logic.GameManager;
import com.example.spacechickens.Sensors.SensorDetector;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String[] typeImage = new String[]{"ic_chicken", "ic_star"};
    ...
    private void handleSwiperCollision() {
        if (!gameManager.isGameOver()) {
            ...
            runOnUiThread(() -> {
                ...
                Signal.getInstance().vibrate();
                Signal.getInstance().toast("Collision with Chicken!");
            });
        }
    }
